...
import { timeAgo, formatDecimal } from "@/lib/utils";
      ...
      {nearby && nearby.length === 0 && !error && (
        <div className="text-center py-4">
          ...
          <p className="text-xs text-[var(--color-text-muted)]">
            Vezi ceva în vecinătate? <Link href="/sesizari" className="text-[var(--color-primary)] hover:underline">Raportează</Link>.
          </p>
        </div>
      )}
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 text-xs text-[var(--color-text-muted)] mt-0.5">
                      ...
                      <span>{formatDecimal(s.distance, 1)} km</span>
