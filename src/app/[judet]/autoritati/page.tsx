...
Dacă cunoști datele de contact ale instituțiilor din {county.name}, deschide un issue pe <a href="https://github.com/andrei1000z/civic-bucuresti/issues" target="_blank" rel="noreferrer" className="underline font-medium">GitHub</a>.
          </p>
        </div>
      )}
