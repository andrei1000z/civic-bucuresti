...
const SECTOR_KEYWORDS: Record<string, string[]> = {
  S1: [
    "sector 1", "s1", "herăstrău", "herastrau", "dorobanți", "dorobanti", "floreasca", "primăverii", "primaverii",
  ...
  S2: [
    "sector 2", "s2", "pantelimon", "colentina", "obor", "tei", "iancului", "vatra luminoasă", "vatra luminoasa",
  ...
  S3: [
    "sector 3", "s3", "titan", "dristor", "vitan", "unirii", "dudești", "dudesti", "ior", "nicolae grigorescu",
  ...
  S4: [
    "sector 4", "s4", "berceni", "tineretului", "apărătorii patriei", "aparatorii patriei", "timpuri noi",
  ...
  S5: [
    "sector 5", "s5", "rahova", "ferentari", "ghencea", "cotroceni", "13 septembrie", "alexandriei",
  ...
  S6: [
    "sector 6", "s6", "drumul taberei", "militari", "crângași", "crangasi", "grozăvești", "grozavesti",
