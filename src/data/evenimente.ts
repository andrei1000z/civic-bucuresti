...
export const evenimente: Eveniment[] = [
  {
    id: "ev-001",
    slug: "rahova-2025",
    titlu: "Explozia devastatoare din Rahova",
    data: "2025-10-17",
    category: "incendiu",
    severity: "critic",
    descriere:
      "Explozie puternică pe Calea Rahovei nr. 317 cauzată de o fisură într-o conductă subterană de gaz. Blocul de 8 etaje distrus ireversibil, recomandat pentru demolare.",
