...
export const PREFECTURI: Record<string, AuthorityContact> = {
  ...
  AG: { phone: "0248-212-550", website: "https://ag.prefectura.mai.gov.ro" },
  ...
  BN: { phone: "0263-212-057", website: "https://bn.prefectura.mai.gov.ro" },
  ...
  CS: { phone: "0255-211-404", website: "https://cs.prefectura.mai.gov.ro" },
  ...
  CV: { phone: "0267-312-235", website: "https://cv.prefectura.mai.gov.ro" },
  DB: { phone: "0245-211-051", website: "https://db.prefectura.mai.gov.ro" },
  ...
  HR: { phone: "0266-371-231", website: "https://hr.prefectura.mai.gov.ro" },
  ...
  OT: { phone: "0249-414-058", website: "https://ot.prefectura.mai.gov.ro" },
  ...
  TR: { phone: "0247-311-010", website: "https://tr.prefectura.mai.gov.ro" },
...
export const PRIMARII: Record<string, AuthorityContact> = {
  ...
  GJ: { phone: "0253-213-246", website: "https://www.primariatgjiu.ro", address: "B-dul Ecaterina Teodoroiu nr. 4, Târgu Jiu" },
...
export const POLITIA_LOCALA_JUDET: Record<string, AuthorityContact> = {
  ...
  AR: { phone: "0257-210-002", website: "https://politialocala-arad.ro", address: "B-dul Revoluției nr. 75, Arad" },
  ...
  BH: { phone: "0259-441-144", website: "https://politialocala-oradea.ro", address: "Str. Primăriei nr. 22, Oradea" },
  ...
  BV: { phone: "0268-954", website: "https://www.polcombv.ro", address: "B-dul Eroilor nr. 8, Brașov" },
  ...
  CL: { phone: "0242-331-551", website: "https://politialocalacl.ro", address: "Str. București nr. 140, Călărași" },
  ...
  GJ: { phone: "0253-214-440", website: "https://www.politialocalatgjiu.ro", address: "B-dul Ecaterina Teodoroiu nr. 4, Târgu Jiu" },
  ...
  IS: { phone: "0232-232-099", website: "https://politialocala-iasi.ro", address: "Str. Bucium nr. 30, Iași" },
